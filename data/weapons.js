...
const WEAPONS = {
    ...
    swords: [
        ...
        { id: "lancereaver", name: "ソードキラー", type: "sword", might: 9, weight: 11, hit: 75, crit: 5, range: [1], rank: "C", effective: ["lance"] },
        ...
        { id: "sol_katti", name: "ソール・カティ", type: "sword", might: 12, weight: 14, hit: 95, crit: 25, range: [1], rank: "Prf" },
        { id: "durandal", name: "デュランダル", type: "sword", might: 17, weight: 16, hit: 90, crit: 0, range: [1], rank: "Prf", bonusStr: 5 },
    ...
    lances: [
        ...
        { id: "axereaver", name: "ランスキラー", type: "lance", might: 10, weight: 11, hit: 70, crit: 5, range: [1], rank: "C", effective: ["axe"] },
        { id: "horseslayer", name: "ホースキラー", type: "lance", might: 7, weight: 13, hit: 70, crit: 0, range: [1], rank: "D", effective: ["cavalry"] },
        { id: "heavy_spear", name: "ヘビースピア", type: "lance", might: 9, weight: 14, hit: 70, crit: 0, range: [1], rank: "C", effective: ["armor"] },
    ...
    axes: [
        ...
        { id: "swordreaver", name: "アクスキラー", type: "axe", might: 11, weight: 13, hit: 65, crit: 5, range: [1], rank: "C", effective: ["sword"] },
        ...
        { id: "armads", name: "アルマーズ", type: "axe", might: 18, weight: 18, hit: 85, crit: 0, range: [1], rank: "Prf", bonusDef: 5 },
    ...
    anima: [
        ...
        { id: "forblaze", name: "フォルブレイズ", type: "anima", might: 14, weight: 11, hit: 85, crit: 5, range: [1, 2], rank: "Prf", bonusRes: 5 },
    ],

    // ===== 光魔法 =====
    light: [
        { id: "lightning", name: "ライトニング", type: "light", might: 4, weight: 1, hit: 95, crit: 5, range: [1, 2], rank: "E" },
        { id: "shine", name: "シャイン", type: "light", might: 6, weight: 2, hit: 90, crit: 8, range: [1, 2], rank: "D" },
        { id: "divine", name: "ディヴァイン", type: "light", might: 8, weight: 12, hit: 85, crit: 10, range: [1, 2], rank: "C" },
        { id: "purge", name: "リザイア", type: "light", might: 10, weight: 14, hit: 75, crit: 5, range: [3, 10], rank: "B", drain: true },
        { id: "aura", name: "オーラ", type: "light", might: 12, weight: 8, hit: 90, crit: 15, range: [1, 2], rank: "A" },
        { id: "luce", name: "ルーチェ", type: "light", might: 16, weight: 6, hit: 95, crit: 25, range: [1, 2], rank: "S" },
        { id: "aureola", name: "アーリアル", type: "light", might: 14, weight: 6, hit: 90, crit: 5, range: [1, 2], rank: "Prf", effective: ["monster"] },
    ],
